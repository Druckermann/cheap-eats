...
# file = URI.open('#')
# deal_1.photo.attach(io: file, filename: '#')
# deal_1.save

deal_2 = Deal.create(name: "White Potato", category: "Vegetable", price: "0.69", description: "Stock up on white potatoes for only $0.69/kg at Queen Victoria Market in Melbourne!", start_date: "2023-05-01", end_date: "2023-05-07", user_id: 2, submission_date: "2023-05-03")
# file = URI.open('#')
# deal_2.photo.attach(io: file, filename: '#')
# deal_2.save
...
# file = URI.open('#')
# deal_3.photo.attach(io: file, filename: '#')
# deal_3.save

deal_4 = Deal.create(name: "Green Seedless Grapes", category: "Fruit", price: "2.99", description: "Get a great deal on green seedless grapes at Coles in Melbourne CBD this week!", start_date: "2023-05-02", end_date: "2023-05-08", user_id: 2, submission_date: "2023-05-02")
# file = URI.open('#')
# deal_4.photo.attach(io: file, filename: '#')
# deal_4.save

deal_5 = Deal.create(name: "Broccoli", category: "Vegetable", price: "1.49", description: "Stock up on fresh broccoli for only $1.49/bunch at Aldi in Melbourne!", start_date: "2023-05-01", end_date: "2023-05-07", user_id: 4, submission_date: "2023-05-02")
# file = URI.open('#')
# deal_5.photo.attach(io: file, filename: '#')
# deal_5.save

deal_6 = Deal.create(name: "Gala Apples", category: "Fruit", price: "2.99", description: "Found a great deal on gala apples at IGA XPress Exhibition Street!", start_date: "2023-05-02", end_date: "2023-05-08", user_id: 2, submission_date: "2023-05-01")
# file = URI.open('#')
# deal_6.photo.attach(io: file, filename: '#')
# deal_7.save

deal_7 = Deal.create(name: "Clementines", category: "Fruit", price: "1.99", description: "Get a great deal on clementines at Woolworths in South Melbourne this week!", start_date: "2023-05-02", end_date: "2023-05-08", user_id: 4, submission_date: "2023-05-01")
# file = URI.open('#')
# deal_7.photo.attach(io: file, filename: '#')
# deal_7.save

deal_8 = Deal.create(name: "Carrots", category: "Vegetable", price: "0.99", description: "Stock up on fresh carrots for only $0.99/bunch at Woolworths Abbotsford!", start_date: "2023-05-01", end_date: "2023-05-07", business_id: 1, submission_date: "2023-05-01")
# file = URI.open('#')
# deal_8.photo.attach(io: file, filename: '#')
# deal_8.save

deal_9 = Deal.create(name: "Beef Sirloin Steak", category: "Meat", price: "9.99", description: "Get beef sirloin steak for $9.99/kg at Coles Richmond Traders!", start_date: "2023-05-03", end_date: "2023-05-10", business_id: 2, submission_date: "2023-05-02")
# file = URI.open('#')
# deal_9.photo.attach(io: file, filename: '#')
# deal_9.save
...
# file = URI.open('#')
# recipe_1.photo.attach(io: file, filename: '#')
# recipe_1.save
...
# file = URI.open('#')
# recipe_2.photo.attach(io: file, filename: '#')
# recipe_2.save
...
# file = URI.open('# ')
# recipe_3.photo.attach(io: file, filename: '#')
# recipe_3.save
...
# file = URI.open('# ')
# recipe_4.photo.attach(io: file, filename: '#')
# recipe_4.save
...
# file = URI.open('#')
# recipe_5.photo.attach(io: file, filename: '#')
# recipe_5.save
...
# file = URI.open('#')
# recipe_6.photo.attach(io: file, filename: '#')
# recipe_6.save
...
# file = URI.open('#')
# recipe_7.photo.attach(io: file, filename: '#')
# recipe_7.save
...
# file = URI.open('#')
# recipe_8.photo.attach(io: file, filename: '#')
# recipe_8.save
...
# file = URI.open('#')
# recipe_9.photo.attach(io: file, filename: '#')
# recipe_9.save
...
# file = URI.open('#')
# recipe_10.photo.attach(io: file, filename: '#')
# recipe_10.save
...
# file = URI.open('#')
# recipe_11.photo.attach(io: file, filename: '#')
# recipe_11.save
...
# file = URI.open('#')
# recipe_12.photo.attach(io: file, filename: '#')
# recipe_12.save
...
# file = URI.open('#')
# recipe_13.photo.attach(io: file, filename: '#')
# recipe_13.save
...
# file = URI.open('#')
# recipe_14.photo.attach(io: file, filename: '#')
# recipe_14.save
...
# file = URI.open('#')
# recipe_15.photo.attach(io: file, filename: '#')
# recipe_15.save
...
# file = URI.open('#')
# recipe_16.photo.attach(io: file, filename: '#')
# recipe_16.save
...
# file = URI.open('#')
# recipe_17.photo.attach(io: file, filename: '#')
# recipe_17.save
...
# file = URI.open('#')
# recipe_18.photo.attach(io: file, filename: '#')
# recipe_18.save
